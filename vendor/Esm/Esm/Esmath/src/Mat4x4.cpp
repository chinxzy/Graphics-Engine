...
namespace Esm {
	...
	void Mat4x4::SetupOrientation(const EulerAngles& orient)
	{
		//To do............
	}
    ...
    Mat4x4& Mat4x4::RotateFromObjectToInertial(const Quaternion& inverse_orient)
	{
		...
		this->SetMat4x4Type(ES_ROTATION_MATRIX);
		*this = Invert(*this);
    ...
    void Mat4x4::SetMat4x4Type(Mat4x4_Type type)
	{
		MatrixType = type;
	}
	...
	Mat4x4 Invert(Mat4x4& m)
	{
		...
		if (m.MatrixType == ES_ROTATION_MATRIX)
		{
